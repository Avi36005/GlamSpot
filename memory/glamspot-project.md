...
- Razorpay / Twilio / Firebase / Cloudinary **stubbed**; user will provide keys later. AI (Gemini for vision, Groq Llama 3.3 70B for chat + review summaries — OpenAI/GPT-4o removed) built with **smart fallbacks** so everything works with zero keys; add keys in `.env` to go live.
