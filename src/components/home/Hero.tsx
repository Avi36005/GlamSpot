  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden">
      ...
      >
        ...
        {/* Headline — elegant 2-line with stagger reveal */}
        ...
        {/* Search bar — glassmorphic, spring entrance, hover lift */}
        <motion.div
          ...
          style={{
            ...
            borderWidth: 1.5,
            boxShadow: focused
              ? "0 0 30px rgba(201, 24, 74, 0.35), 0 25px 60px rgba(0, 0, 0, 0.35)"
              : "0 20px 60px rgba(0, 0, 0, 0.25)",
          }}
          className="mt-8 w-full max-w-3xl rounded-2xl bg-white/75 backdrop-blur-[20px] p-2 md:flex md:items-center md:gap-2 transition-all duration-300 hover:shadow-[0_25px_50px_rgba(0,0,0,0.2)] hover:-translate-y-0.5"
        >
          ...
          <Magnetic className="mt-2 w-full md:mt-0 md:w-auto">
            <motion.button
              ...
              className="hero-search-btn w-full rounded-xl bg-accent px-7 py-3.5 font-medium uppercase tracking-[0.04em] text-white transition-colors hover:bg-accent-dark cursor-pointer"
            >
              Search
            </motion.button>
          </Magnetic>
        ...
        {/* Trending Searches — hover scale + fill search */}
        <motion.div
      ...
      {/* Scroll cue — "Discover Salons" with subtle float */}
      <motion.div
        style={{ opacity: contentOpacity }}
        className="pointer-events-none absolute bottom-8 left-1/2 hidden -translate-x-1/2 flex-col items-center gap-2 text-white/60 md:flex"
      >
